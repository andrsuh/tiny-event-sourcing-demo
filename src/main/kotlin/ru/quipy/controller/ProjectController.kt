...
class ProjectController(
    ...
    fun createStatus(@PathVariable projectId: UUID, @PathVariable statusName: String,
                     @PathVariable statusColor: String): StatusCreatedEvent{
    ...
    fun assignStatus(@PathVariable projectId: UUID,
                             @PathVariable taskId: UUID,
                             @PathVariable statusId: UUID) : StatusAssignedToTaskEvent {
        return projectEsService.update(projectId) {
    ...
    fun renameTask(@PathVariable projectId: UUID,
                   @PathVariable taskId: UUID,
                   @PathVariable newName: String) : TaskRenamedEvent {
        return projectEsService.update(projectId) {
    ...
    fun assignUser(@PathVariable projectId: UUID,
                   @PathVariable taskId: UUID,
                   @PathVariable userId: UUID): UserAssignedToTaskEvent {
        return projectEsService.update(projectId) {
